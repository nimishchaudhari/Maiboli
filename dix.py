...
#Greek
# Yoruba
yrb = ['tẹjade', 'fun', 'ti', 'abiti', 'ajebe', 'dapada', 'agbewọle', 'ṣe', 'leefo', 'odidi', 'gigun', 'opọju', 'okereju', 'larin' 'yika', 'oro', 'aropo', 'soodi', 'ninu', 'looto', 'iro', 'itumo', 'ati', 'tabi', 'kiiṣe', 'bi', 'duro', 'tẹsiwaju', 'ipari','fun' ]
...
#yrb_final = ['tẹjade                        ', 'fun                           ', 'ti                            ', 'abiti                         ', 'ajebe                         ', 'dapada                        ', 'agbewọle                      ', 'ṣe                            ', 'leefo                         ', 'odidi                         ', 'gigun                         ', 'opọju                         ', 'okereju                       ', 'larinyika                     ', 'oro                           ', 'aropo                         ', 'soodi                         ', 'ninu                          ', 'looto                         ', 'iro                           ', 'itumo                         ', 'ati                           ', 'tabi                          ', 'kiiṣe                         ', 'bi                            ', 'duro                          ', 'tẹsiwaju                      ', 'ipari                         ']
